...
public class RetailExclFuel extends Indicator {

	public enum Countries {a, b};	
	public RetailExclFuel(boolean sa) {
	...
	public boolean equals(Indicator j) {		
		...
		if (! (j instanceof RetailExclFuel) || this.sa != j.isSa() || this.p != j.getPeriodicity() || this.t != j.getType()) {
			return false;
		} else {
			return true;
		}	
