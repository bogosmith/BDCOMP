...
public class TourismAllAccomodation extends Indicator {
	
	public TourismAllAccomodation(boolean sa) {
	...
	public boolean equals(Indicator j) {		
		...
		if (! (j instanceof TourismAllAccomodation) || this.sa != j.isSa() || this.p != j.getPeriodicity() || this.t != j.getType()) {
			return false;
		} else {
			return true;
		}	
